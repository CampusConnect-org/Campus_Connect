...
const Footer = () => {
  return (
    <footer style={{ backgroundColor: 'black', color: 'white', padding: '8px', textAlign:"center", bottom:"0", width:"100vw", marginTop:"0px"}}>
      <div style={{padding: "10px"}}>
        ...
        <a href="https://instagram.com/campus._.connect?igshid=MmIzYWVlNDQ5Yg==" style={{margin:"10px"}}><i className="fab fa-instagram" style={{fontSize:"20px", color:"#FF0B6E"}}></i></a>
      </div>
      <div>
        {/* Generic text */}
